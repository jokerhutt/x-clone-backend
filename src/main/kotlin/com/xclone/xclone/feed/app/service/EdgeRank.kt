package com.xclone.xclone.feed.app.service

import com.xclone.xclone.feed.app.dto.PostRank
import com.xclone.xclone.feed.app.util.EdgeRankUtils
import com.xclone.xclone.feed.domain.entity.FeedEntry
import com.xclone.xclone.feed.infra.repository.FeedEntryRepository
...
class EdgeRank(
    ...
    fun saveFeed(userId: Int, feed: List<PostRank>) {
        ...
        val feedEntries : ArrayList<FeedEntry> = EdgeRankUtils.generateFeedEntriesList(userId, feed)
    ...
    private fun computeLikeWeights(postToRank: PostRank): Float {
        ...
        return ln((likes.size + 1).toDouble()).toFloat()
    }
